...
Во вкладке _Макет_ можно настроить отступы и интервалы между абзацами, а также параметры расстановки переносов. Там же находится функционал, связанный с представлением текста в несколько колонок.Обработка ссылок
