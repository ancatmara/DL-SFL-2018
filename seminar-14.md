...
Для любителей головоломок и задачек на логику есть кроссворды, основанные на регулярных выражениях! Вот на [этом сайте](https://regexcrossword.com/) есть пошаговый тьюториал и кроссворды всех мастей и уровней, а [вот](https://mariolurig.com/crossword/), например, кроссворд с MIT Puzzle Hunt.
